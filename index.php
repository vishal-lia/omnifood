...
<head>
    ...
    <meta name="description" content="Omnifood is premium food delivery service with the mission to bring affordable 
food and healthy meals to as many people as possible.">
    <meta name="keywords" content="Omnifood, Food, Omni, Organic">
...
<body>
    ...
    <section class="section-steps" id="steps">
        ...
        <div class="row">
            <div class="col span-1-of-2 steps-box">
                <img src="resources/img/app-iPhone.png" alt="Omnifood Iphone App" class="app-screen js--wp-2">
            </div>
            <div class="col span-1-of-2 steps-box">
        ...
        <div class="row">
            ...
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite><img src="resources/img/customer-2.jpg" alt="customer 1">Joana Silva</cite>
                </blockquote>
            </div>
            <div class="col span-1-of-3">
                <blockquote>
                    ...
                    <cite><img src="resources/img/customer-3.jpg" alt="customer 1">Milton Chapman</cite>
                </blockquote>
            </div>
        </div>
    </section>
    ...
    <script type="text/javascript" src="https://maps.google.com/maps/api/js?key=AIzaSyCfeg7V_b7n46BkgKO6dXscBAujif1mrbw"></script>
